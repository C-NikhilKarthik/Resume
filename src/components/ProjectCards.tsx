        ...
        <div className=" grid grid-cols-12 gap-3">
          <div className="part-2 group z-10 check text-end py-2 md:col-[5/-1] large:col-[7/-1]">
            <div className="flProjectTyped">
              ...
              <div className="text-slate-100 font-semibold text-[clamp(20px,5vw,24px)]">{props.heading}</div>
          ...
          <div className="part-1 check md:col-[1/8] flex items-center justify-center">
            <div className="bg-light-navy md:h-auto h-full">
              <img alt="pic" className='md:h-auto h-full object-center object-cover rounded hover:shadow-lg opacity-30 hover:opacity-100 transition-[opacity] duration-300' src='https://user-images.githubusercontent.com/39849261/70559512-cdd78580-1bac-11ea-96a1-cbe7fd5e0452.png' />
            </div>
          </div>
        </div>
      ) : (
