...
function About() {
  ...
  return (
    <div data-aos="fade-right" data-aos-offset="00" data-aos-easing="ease-in-out" data-aos-duration="500" className='relative mt-5 mb-10 w-full sm:mt-32 text-gray-200 backdrop-blur-sm bg-black/50 rounded-lg p-4 '>
